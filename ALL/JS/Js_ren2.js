...
function postDate() {
  ...
  if ($.isEmptyObject(DATA_ALL.first_1_left)) {
    DATA_ALL.first_1_left = "HTY 男";
  }
  if ($.isEmptyObject(DATA_ALL.first_1_right)) {
    DATA_ALL.first_1_right = "学生 19xxxxxx";
  }
  if ($.isEmptyObject(DATA_ALL.first_2)) {
    DATA_ALL.first_2 = "本科生 | 城市建设学部 土木工程 201x级 19xxxx";
  }
  if ($.isEmptyObject(DATA_ALL.first_3)) {
    DATA_ALL.first_3 = "联系电话:190xxxx1234";
  }
  if ($.isEmptyObject(DATA_ALL.chu)) {
    DATA_ALL.chu = "离校# 至因其他请补充说明核酸检查去往北京市垂杨柳医";
  }
  if ($.isEmptyObject(DATA_ALL.ru)) {
    DATA_ALL.ru = "入校# 因其他请补充说明开学返校,乘坐飞机京外入校";
  }
